...
export class PublicationService {
  ...
  public async createPublication(
    ...
    const ipns_addr = new IPNSHash(links.ipns.replace('https://hub.textile.io/', '')); //TODO:consolidate this with below call

    const transaction = await this.blockchainService.createPublication(publication.slug, ipns_addr);
  ...
  public async listArticles(publication_slug: string): Promise<Publication> {
    ...
    //TODO:Resolve publication slug into IPFS address
    const publication_record = await this.blockchainService.getPublication(publication_slug);
